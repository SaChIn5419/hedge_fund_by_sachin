...
class StaticBacktestReporter:
    ...
    def _load_trade_log(self, csv_path: str) -> pd.DataFrame:
        ...
        for col in ['weight', 'gross_weight', 'fwd_return', 'net_pnl', 'leverage_mult', 'regime_confidence', 'breadth', 'macro_score', 'mom_z', 'break_score', 'score', 'long_score', 'short_score', 'nifty_vol', 'efficiency']:
